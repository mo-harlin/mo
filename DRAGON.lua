...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/mo-harlin/mo/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1721540719,1284934171,1932226438}   
...
if tonumber(user_id) == tonumber(1721540719) then  
var = true 
elseif tonumber(user_id) == tonumber(1932226438) then
var = true  
elseif tonumber(user_id) == tonumber(1284934171) then
var = true  
...
local UserName = (data.username_ or "Source_JACK")
local NameUser = " ᥀︙  من قبل  ⇇["..data.first_name_.."](T.me/"..UserName..")"
...
{'•═════•〈〈 𝙅𝘼𝘾𝙆 〉〉•═════•'},
{'لو خيروك','كت تويت'},
{'لو خيروك بالصوره','كت تويت بالصوره'},
{'•═════•〈〈 𝙅𝘼𝘾𝙆 〉〉•═════•'},
{'حروف','بوستات'},
{'عقاب','اذكار'},
{'•═════•〈〈 𝙅𝘼𝘾𝙆 〉〉•═════•'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'جاك') 
local DRAGON_Msg = { 
...
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
...
{'المطور','الاحصائيات'},
{'•═════•〈〈 𝙅𝘼𝘾𝙆 〉〉•═════•'},
{'قسم المبرمجين','قسم مسح ❍ اضف'},
{'قسم تفعيل ❍ تعطيل','قسم الحمايه'},
{'قسم الاذاعه'},
{'•═════•〈〈 𝙅𝘼𝘾𝙆 〉〉•═════•'},
...
os.execute('wget https://raw.githubusercontent.com/mo-harlin/mo/main/DRAGON.lua')
...
if text == 'قسم مسح ❍ اضف' and DevSoFi(msg) then 
...
if text == 'قسم تفعيل ❍ تعطيل' and DevSoFi(msg) then 
...
if text == 'قسم الحمايه' and DevSoFi(msg) then 
...
if text == 'قسم الاذاعه' and DevSoFi(msg) then 
...
if text == '𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊' and DevSoFi(msg) then
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/Source_JACK"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n ᥀︙ العضو   ⇇['..result.title_..'](t.me/'..(username or 'Source_JACK')..')'
status  = '\n ᥀︙ تم ترقيته مطور'
...
usertext = '\n ᥀︙ العضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Source_JACK')..')'
status  = '\n ᥀︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ᥀︙ العضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'Source_JACK')..') \n ᥀︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "جاك")
...
send(msg.chat_id_,0," ᥀︙ العضو  : {["..data.first_name_.."](T.ME/Source_JACK)}\n ᥀︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ᥀︙ عذرا  ⇇{["..data.first_name_.."](T.ME/Source_JACK)}\n ᥀︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n ᥀︙ من قبل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᥀︙تم تشغيل البوت في الجروب  {'..chat.title_..'}\n  وتم ترقيه جميع الادمنيه ',msg.id_/2097152/0.5,'md')
...
Text = ' ᥀︙ تم تشغيل البوت في الجروب جديد\n'..
'\n ᥀︙بواسطة {↝'..Name..'↜}'..
'\n ᥀︙ايدي الجروب {'..IdChat..'}'..
'\n ᥀︙اسم الجروب {['..NameChat..']}'..
...
send(msg.chat_id_, msg.id_,' ᥀︙ البوت معطل من قبل ')
else
sendText(msg.chat_id_,'\n ᥀︙ من قبل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᥀︙ تم تعطيل البوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ᥀︙تم تشغيل البوت في الجروب ')
else
sendText(msg.chat_id_,'\n ᥀︙ من قبل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᥀︙تم تشغيل البوت في الجروب  {'..chat.title_..'}\n  وتم ترقيه جميع الادمنيه ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐕 𝐒𝐇𝐘𝐂𝐎', url="t.me/xx_shico"},{text = '𝐃𝐄𝐕 𝐓𝐈𝐆𝐄𝐑', url="t.me/Oo_tiger"}},
{{text = '𝐖𝐄𝐋𝐂𝐎𝐌 𝐉𝐀𝐂𝐊', url="t.me/Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ROOGEN1/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐕 𝐒𝐇𝐘𝐂𝐎', url="t.me/xx_shico"}},
{{text = '𝐃𝐄𝐕 𝐓𝐈𝐆𝐄𝐑', url="t.me/Oo_tiger"}}, 
{{text = '𝐓𝐖𝐀𝐒𝐎𝐋 𝐉𝐀𝐂𝐊', url="t.me/VOLT3R_bot"}}, 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊', url="t.me/Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تايجر' or text == 'تايجر الهقر' or text == 'تايجر الهكر' or text == 'مطور السورس' then
local Text = [[
تايجر مطور جاك لوحابب تتواصل معاه ❤️.

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐕 𝐓𝐈𝐆𝐄𝐑', url="t.me/Oo_tiger"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊', url="t.me/Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Oo_tiger&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《 مـــطـــور الـبـــوت 》](t.me/Source_JACK)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ᥀︙ تم تعطيل جلب الصوره ،\n ᥀︙ تم قفل البوتات  ،\n ᥀︙ تم قفل التكرار ،\n ᥀︙ تم قفل الروابط ،\n ᥀︙ تم قفل التوجيه ،\n ᥀︙ تم قفل الملصقات ،\n ᥀︙ تم قفل المتحركه ،\n ᥀︙ تم قفل الفيديو ،\n ᥀︙ تم قفل الفشار ،\n ᥀︙ تم قفل الانلاين ،\n ᥀︙ تم قفل تعديل المديا ،\n ᥀︙ تم وضع التكرار  ،\n ᥀︙ تم قفل الفارسيه  ،\n ᥀︙ تم وضع الايدي بدون صوره ،\n ᥀︙ تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'Source_JACK')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'Source_JACK')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ᥀︙  من قبل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_JACK')..') \n ᥀︙ تم قفل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1721540719) then  
send(msg.chat_id_, msg.id_, " ᥀︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1284934171) then  
send(msg.chat_id_, msg.id_, " ᥀︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1284934171) then
send(msg.chat_id_, msg.id_, " ᥀︙ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1721540719) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1721540719) then  
send(msg.chat_id_, msg.id_, " ᥀︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1284934171) then  
send(msg.chat_id_, msg.id_, " ᥀︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/mo-harlin/mo/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ᥀︙ اهلا بك في متجر ملفات جاك\n ᥀︙ ملفات السورس ◍- - - - - - - -×- - - - - - - -◍\n◍- - - - - - - -×- - - - - - - -◍\n"
local TextE = "\n◍- - - - - - - -×- - - - - - - -◍\n ᥀︙ علامة تعني { ✔️ } ملف مفعل\n ᥀︙ علامة تعني { ✖ } ملف معطل\n ᥀︙ قناة سورس جاك◍- - - - - - - -×- - - - - - - -◍\n".." ᥀︙ [اضغط هنا لدخول](t.me/Source_JACK) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/mo-harlin/mo/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ᥀︙ عذرا الملف لايدعم سورس جاك\n") 
end
return false
end
...
if text == ("مسح قائمه جاك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ᥀︙ تم مسح قائمه جاك')
return false
end

if text == 'قائمه جاك' and Sudo(msg) then
...
if text == ("رفع جاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
if text and text:match("^رفع جاك@(.*)$") and Sudo(msg) then
local username = text:match("^رفع جاك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
if text and text:match("^رفع جاك(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع جاك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
if text == ("تنزيل جاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
if text and text:match("^تنزيل جاك@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل جاك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
if text and text:match("^تنزيل جاك(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل جاك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Source_JACK = database:get(bot_id..'text:ch:user')
if Source_JACK then
send(msg.chat_id_, msg.id_,'['..Source_JACK..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ᥀︙ لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Source_JACK')..')'
status  = '\n ᥀︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ᥀︙ العضو   ⇇'..userid..''
...
' }\n'..' ᥀︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ᥀︙  الرفع  ⇇{ '..setadd..
' }\n'..' ᥀︙  الحظر  ⇇{ '..banm..' }\n\n ᥀︙═───═❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊](t.me/Source_JACK)❳═───═ ᥀︙\n ᥀︙ قناة سورس جاك◍- - - - - - - -×- - - - - - - -◍\n [ ❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊](t.me/Source_JACK)❳](t.me/Source_JACK) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ᥀︙ العضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'Source_JACK')..')'..'\n ᥀︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Source_JACK:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Source_JACK:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Source_JACK:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Source_JACK:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_," ᥀︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Source_JACK:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Source_JACK:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس جاكيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جاك').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه🤦‍♂️❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝❤️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
if text == 'البوت وقف' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, 'لا انا شغال متحوارش 🤔❤') 
return false
end
...
send(msg.chat_id_,msg.id_, '[بعشقق يواد.🥰❤️](t.me/Source_JACK)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_JACK')..')'
local iduser = result.sender_user_id_
...
🎮 اهلا بك في قسم الالعاب بسورس جاك ⇊
 اختر العبه الذي تريدهاده من الازرار بلاسفل⇊
◍- - - - - - - -×- - - - - - - -◍
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐂𝐊](t.me/Source_JACK)
]]
keyboard = {} 
...
if text == 'امر العضو' or text == 'اوامر الأعضاء' or text == 'اوامر الاعضاء' then
local Text = [[
 اتبع الاوامر الاعضاء
 ◍- - - - - - - -×- - - - - - - -◍
 تحت لي في الزر الاسفل⇊
 ◍- - - - - - - -×- - - - - - - -◍
 ..
]]
keyboard = {} 
...
if text == "رد عليه يابوت" or text == "رد عليه" or text == "رد انت يابوت" then
...
send(msg.chat_id_, msg.id_," ᥀︙تم تفعيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ᥀︙ تم تعطيل مريم") 
return false end
end
if text == "مريم" then
